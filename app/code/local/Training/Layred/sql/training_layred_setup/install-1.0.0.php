...
$tableName = $installer->getTable('training_layred/attribute_url_key');
...
/**
 * Create table 'training_layred/attribute_url_key'
 */
$table = $installer->getConnection()
	...
	->addColumn('url_value', Varien_Db_Ddl_Table::TYPE_TEXT, null, array(
        'unsigned' => true,
        ), 'Url Value')	
